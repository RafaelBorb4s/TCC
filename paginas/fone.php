...
$nome = "";
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        $categoria = "fone"; //Mudar de acordo com a página
        ...
        if(empty($link) and empty($valor) and empty($produto)){
            ...
            if(mysqli_query($conexao, $comentar)){
                header('Location: fone.php');//Mudar de acordo com as paginas
            }
        }   
    }
...
<body>
    ...
    <div class="titulo_paginas"><h2>Fone</h2></div>

    <div class="conteudo">
        <?php
            $seleciona = mysqli_query($conexao, "SELECT * FROM `publicacoes` WHERE categoria = 'fone' ORDER BY 'id' DESC"); //Mudar de acordo com a pagina
    ...
    <div class="Modal">
        ...
        <div class="modal_body">
            <div class="modal_form">
                ...
                <div class="titulo_modal"><H2 id="h2_modal">Fone</H2></div>
                <form method="post">
