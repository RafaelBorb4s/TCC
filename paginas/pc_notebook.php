...
$nome = "";
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        $categoria = "PC"; //Mudar de acordo com a página
...
<body>
    ...
    <div class="conteudo">
        <?php
            $seleciona = mysqli_query($conexao, "SELECT * FROM `publicacoes` WHERE categoria = 'PC' ORDER BY 'id' DESC"); //Mudar de acordo com a pagina
