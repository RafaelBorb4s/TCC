...
$nome = "";
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        $categoria = "Processador"; //Mudar de acordo com a página
        ...
        if(empty($link) and empty($valor) and empty($produto)){
            ...
            if(mysqli_query($conexao, $comentar)){
                header('Location: processador.php');//Mudar de acordo com as paginas
            }
        }   
    }
...
<body>
    ...
    <div class="titulo_paginas"><h2>Processador</h2></div>

    <div class="conteudo">
        <?php
            $seleciona = mysqli_query($conexao, "SELECT * FROM `publicacoes` WHERE categoria = 'Processador' ORDER BY 'id' DESC"); //Mudar de acordo com a pagina
        ...
        <div class="nome"><p>Usuário: <b><?php echo $nome1; ?></b><a id="editar_publi" <?php echo "href= editar.php?id=$id";?> ><?php if(strtolower($nome) == strtolower($nome1)){echo "Editar";} ?></a><a id="deletar_publi" <?php echo "href= delete.php?id=$id";?>> <?php if(strtolower($nome) == strtolower($nome1)){echo "&#x274C;";} ?></a></p></div>
            ...
            <div class="data_publi"><p>Publicado: <i class="fa-regular fa-clock"></i> <?php echo $data1; ?> ás <?php echo $hora1; ?></p></div>
    ...
    <div class="Modal">
        ...
        <div class="modal_body">
            <div class="modal_form">
                ...
                <div class="titulo_modal"><H2 id="h2_modal">Processador</H2></div>
                <form method="post">
