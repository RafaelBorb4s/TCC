...
<body>
    ...
    <div class="titulo_paginas"><h2>Resultado da Pesquisa!</h2></div>

    <div class="conteudo">
        <?php
               
            $sql = "SELECT * FROM `publicacoes` WHERE produto LIKE '%$pesquisa%'";
            $seleciona = mysqli_query($conexao, $sql);
            $conta = mysqli_num_rows($seleciona); 

            if($conta <= 0){
                echo"<p id=".'sem_publi'.">Não encontramos nada relacionado com $pesquisa! &#x1F615;</p>";
            }else{
