...
$nome = "";
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        $categoria = "placa_mae"; //Mudar de acordo com a página
        ...
        if(empty($link) and empty($valor) and empty($produto)){
            ...
            if(mysqli_query($conexao, $comentar)){
                header('Location: placa_mae.php');//Mudar de acordo com as paginas
            }
        }   
    }
...
<body>
    ...
    <div class="titulo_paginas"><h2>Placa Mãe</h2></div>

    <div class="conteudo">
        <?php
            $seleciona = mysqli_query($conexao, "SELECT * FROM `publicacoes` WHERE categoria = 'placa_mae' ORDER BY 'id' DESC"); //Mudar de acordo com a pagina
    ...
    <div class="Modal">
        ...
        <div class="modal_body">
            <div class="modal_form">
                ...
                <div class="titulo_modal"><H2 id="h2_modal">Placa Mãe</H2></div>
                <form method="post">
